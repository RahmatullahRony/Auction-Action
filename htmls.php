...
function headhtml()
{
	echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
			...
			<div id="main_container">
				...
				<div id="header">
					<div id="logo"> <a href="#"><img src="images/1122.png" alt="" border="0" width="237" height="200" /></a> </div>
...
function foothtml()
{
	echo ' <div class="footer">
					<div class="left_footer"> <img src="images/cp.png" alt="" width="170" height="49"/> </div>
					<div class="center_footer"> Auction Action. All Rights Reserved 2008<br />
