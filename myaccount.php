...
<div id="main_content">
	...
	<div class="left_content">
		...
		<ul class="left_menu">
			...
			<div class="banner_adds"> <a href="#"><img src="images/bann2.gif" alt="" width="200" /></a> </div>
	</div>
	<!-- end of left content -->
	<?php
	$userid = $_SESSION['ID'];
	$query = mysqli_query($db, "SELECT * FROM member WHERE memberid = '$userid'");
	...
	if (isset($_POST['prodsave'])) {
		...
		mysqli_query($db, "INSERT INTO products(prodname,categoryid,prodescription,startingbid,prodimage,dateposted,duedate,status,sellername,sellerpayaccount) 
				...
				<div class="details_big_box">
					...
					<div id="regstep1">
						...
						if (isset($_POST['save'])) {
							...
							mysqli_query($db, "UPDATE member SET lastname='$last_save', firstname='$fname_save', gender='$gender_save', address='$address_save', birthdate='$bday_save' WHERE memberid='$userid'");
					...
					<div id="form_row1">
						...
						if (isset($_POST['btnsave'])) {
							...
							mysqli_query($db, "UPDATE member SET password='$password_save', memberimg='$name' WHERE memberid='$userid'");
		...
		<div class="prod_box">
			...
			<div class="center_prod_box">
				<div id='showmsgandnotifs'>
					<div class="product_img"><img src="images/Mail[1].png" width="120" height="90" alt="" /></div>
						...
						<div class="specifications">
							...
							<div class='hidenotif'>
								<div class="thumbs">
									...
									<?php
									$get = mysqli_query($db, "SELECT * FROM needtopay WHERE needtopay.memberid = '$userid' AND needtopay.status=0");
									while ($getit = mysqli_fetch_array($get)) {
										$prod = $getit['productid'];
										$getprod = mysqli_query($db, "SELECT * FROM products WHERE productid = '$prod'");
